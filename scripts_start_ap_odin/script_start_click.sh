...
# For testing
# ovs-ofctl add-flow br0 in_port=3,dl_type=0x0800,nw_proto=17,tp_dst=67,actions=output:1,2
# ovs-ofctl add-flow br0 in_port=2,dl_type=0x0800,nw_proto=17,tp_dst=68,actions=output:1,3
